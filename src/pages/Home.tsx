  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${hovered ? accentColor + "66" : "rgba(148,163,184,0.1)"}`,
        color: "#ecfdf5",
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        /* Animated diagonal blue stripes */
        .dash-bg::before {
          content: '';
          position: fixed;
          inset: -50%;
          ...
          background-image: repeating-linear-gradient(
            ...
            transparent 0px,
            transparent 36px,
            rgba(29, 78, 216, 0.06) 36px,
            rgba(29, 78, 216, 0.06) 38px,
            transparent 38px,
            transparent 78px,
            rgba(15, 55, 160, 0.03) 78px,
            rgba(15, 55, 160, 0.03) 80px
          );
          animation: stripeShift 24s linear infinite;
          pointer-events: none;
          z-index: 0;
        }

        /* Blue radial bloom glows */
        .dash-bg::after {
          content: '';
          position: fixed;
          inset: 0;
          background:
            radial-gradient(ellipse 65% 50% at 10% 15%, rgba(29,78,216,0.22) 0%, transparent 60%),
            radial-gradient(ellipse 50% 45% at 88% 82%, rgba(7,89,133,0.18) 0%, transparent 55%),
            radial-gradient(ellipse 40% 50% at 55% 48%, rgba(15,23,80,0.12) 0%, transparent 65%);
          pointer-events: none;
          z-index: 0;
      ...
      <div
        ...
        style={{
          ...
          flexDirection: "column",
          minHeight: "100vh",
          background: "linear-gradient(160deg, #020b18 0%, #030d1f 50%, #020912 100%)",
          position: "relative",
        }}
      >
        {/* TOP HEADER */}
